...
class PollsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'pstate' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'polls_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
'engine' => 'InnoDB', 'collation' => 'utf8_bin'
    ...
    public $records = [
        [
            ...
            'pstate' => 'Lorem ipsum dolor sit amet',
            'logo' => 'Lorem ipsum dolor sit amet',
            'created' => '2015-04-26 00:19:51',
            'modified' => '2015-04-26 00:19:51'
        ],
    ];
}
