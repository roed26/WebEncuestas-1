 ...
 *
 */
class AnswerTextFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            'answer_text_ibfk_1' => ['type' => 'foreign', 'columns' => ['question_id'], 'references' => ['questions', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
